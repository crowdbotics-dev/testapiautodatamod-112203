...
## Project Structure
    ...
    ├── testapiautodatamod_112203  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112203`
...
2. Clone this repo and `cd testapiautodatamod_112203`
